...
public class Stepper implements ValidationRuleListener,
    ...
    private List<ValidationRuleListener> listeners = new ArrayList<ValidationRuleListener>();
    ...
    public void consumeEvent(ValidationRuleEvent e, DataContext ctx) {
        ...
        if (ValidationRuleType.INIT.equals(e.getType())) {
            ...
            if (h == null) {
                throw new IllegalStateException("field " + e.getPosition()
...
class StepperExtension extends EventExtension<StepperHelper> implements
    ...
    HashMap<String, StepperHelper> mapping;
    ...
    private HashMap<String, StepperHelper> getMapping(String tabOrder) {
        HashMap<String, StepperHelper> mapping = new HashMap<String, StepperHelper>();
    ...
    public void incMapping(ValidationRuleEvent ev) {
        ...
        if (m != null) {
            ...
            throw new IllegalStateException("Field " + ev.getPosition()
                    + " is missing ");
        }
    }
    ...
    public int compare(ValidationRuleEvent arg0, ValidationRuleEvent arg1) {
        if (getData(arg0) == null) {
            throw new IllegalStateException("Field " + arg0.getPosition()
                    + " is missing ");
        }
        ;
        if (getData(arg1) == null) {
            throw new IllegalStateException("Field " + arg1.getPosition()
                    + " is missing ");
        }
